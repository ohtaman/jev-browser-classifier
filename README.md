...
const jev = await loadJev(); // Gemma 4 E2B IT, q4f16 ONNX, WebGPU
...
This API runs in a WebGPU browser. Model loading transfers several GB from Hugging Face and may happen again after a page reload.
